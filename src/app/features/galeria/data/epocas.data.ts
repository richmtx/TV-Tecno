...
export const EPOCAS: Coleccion[] = [
    {
        ...
        fotos: generarFotos(BASE, '1920-1950', 24, [
            ...
            'Aula de clases en los primeros años',
            'Ceremonia cívica en el patio central'
        ])
    },
    {
        id: '1951-1980',
        ...
        fotos: generarFotos(BASE, '1951-1980', 86, [
            ...
            'Laboratorio de prácticas de la época'
        ])
    },
    {
        id: '1981-2000',
    ...
    },
    {
        ...
        fotos: generarFotos(BASE, '2001-2010', 156, [
            ...
            'Nuevas instalaciones del plantel',
